...
<form action="${pageContext.request.contextPath}/UpdateUserServlet?id=${user.id}" method="post" onsubmit="return validate_add_product(this)" class="bootstrap-frm">
		...
		introduce:&nbsp;
		<input type="text" name="introduce value="${user.introduce}"/> <br/>
		state:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="state" value="${user.state}"> <br>
		role:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="role" value="${user.role}"> <br>
		registTime:
		<input type="text" name="registTime" value="${user.registTime}"> <br><br>
