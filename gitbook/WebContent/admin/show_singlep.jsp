...
<form action="${pageContext.request.contextPath}/UpdateProductionServlet?id=${product.id}" method="post" onsubmit="return validate_add_product(this)" class="bootstrap-frm">
		<h1>Please enter information about books</h1>
		id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		num:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="num" value="${product.num}"/> <br/>
		imgurl:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="imgurl" value="${product.imgurl}"/> <br/>
		description:
