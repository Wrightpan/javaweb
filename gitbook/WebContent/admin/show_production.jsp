 ...
 <thead>
    ...
    <tbody>
            <tr>
              ...
              <td><a href="${pageContext.request.contextPath}/ShowSingleP?id=<%=product.getId()%>">UPDATE</a></td>             
              <td><a href="${pageContext.request.contextPath}/DeleteProductionServlet?id=<%=product.getId()%>">DELETE</a></td>
              </td>
            </tr>
