 ...
 <thead>
    ...
    <tbody>
            <tr>
              ...
              <td><a href="${pageContext.request.contextPath}/ShowSingleU?id=<%=user.getId()%>">UPDATE</a></td>             
              <td><a href="${pageContext.request.contextPath}/DeleteUserServlet?id=<%=user.getId()%>">DELETE</a></td>
            </tr>
