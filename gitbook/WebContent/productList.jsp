                        ...
                        <div class="shop-grid tab-pane fade show active" id="nav-list" role="tabpanel">
                            <div class="list__view__wrapper">
                                ...
                                <div class="list__view mt--40">
                                    <div class="thumb">
                                        <a class="first__img" href="${product.description}"><img src="${product.imgurl}" alt="product images"></a>
                                        <a class="second__img animation1" href="${product.description}"><img src="${product.imgurl}" alt="product images"></a>
                                    </div>
                                    <div class="content">
                                        <h2><a href="${product.description}">${product.name}</a></h2>
                                        <ul class="rating d-flex">
                                            <li class="on"><i class="fa fa-star-o"></i></li>
                                            <li class="on"><i class="fa fa-star-o"></i></li>
                                            <li class="on"><i class="fa fa-star-o"></i></li>
                                        ...
                                        <ul class="cart__action d-flex">
                                            <li class="cart"><a href="${pageContext.request.contextPath}/AddCarServlet?id=${product.id}">Add to cart</a></li>
